...
def menu():
    ...
    while True:
        ...
        if opcion == '1':
            ...
            id = input("Ingrese el ID del producto:11111111 ")
            nombre = input("Ingrese el nombre del producto:azucar ")
            cantidad = int(input("Ingrese la cantidad del producto:2 "))
            precio = float(input("Ingrese el precio del producto: 2,50"))
            ...
            id = input("Ingrese el ID del producto a eliminar:11111111 ")
            inventario.eliminar_producto(id)  # Eliminar el producto por su ID

        elif opcion == '3':
            # Opción para actualizar un producto
            id = input("Ingrese el ID del producto a actualizar:22222222 ")
            ...
            nombre = input("Ingrese el nombre del producto a buscar:cafe ")
